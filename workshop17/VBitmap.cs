...
namespace workshop17
{
    ...
    public class VBitmap
    {
        ...
        static public void DrawTexturedQuad(double x0, double y0, double w, double h)
        {
            ...
            GL.TexCoord3(0.0, 0.0, 0.0);
            GL.Vertex3(x0, y0, 0.0);

            GL.TexCoord3(1.0, 0.0, 0.0);
            GL.Vertex3(x0 + w, y0, 0.0);

            GL.TexCoord3(1.0, 1.0, 0.0);
            GL.Vertex3(x0 + w, y0 + h, 0.0);

            GL.TexCoord3(0.0, 1.0, 0.0);
            GL.Vertex3(x0, y0 + h, 0.0);
            GL.End();
        }
    }
}
